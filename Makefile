...
# FLAGS = `pkg-config --cflags --libs /usr/local/Cellar/opencv3/3.1.0_3/lib/pkgconfig/opencv.pc`

# FLAGS = -I/usr/local/opt/opencv3/include/opencv -I/usr/local/opt/opencv3/include -L/usr/local/opt/opencv3/lib -L/usr/local/cuda/lib -lopencv_calib3d  -lopencv_core -lopencv_features2d -lopencv_flann -lopencv_highgui -lopencv_imgproc  -lopencv_ml -lopencv_objdetect  -lopencv_photo -lopencv_stitching -lopencv_superres  -lopencv_video -lopencv_videostab -lcufft -lnpps -lnppi -lnppc -lcudart /usr/local/lib/libtbb.dylib
